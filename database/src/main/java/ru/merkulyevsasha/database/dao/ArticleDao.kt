...
interface ArticleDao {
    @Query("select a.articleId, a.sourceId, s.sourceName, a.title, a.link, " +
        "a.description, a.pubDate, a.lastActivityDate, a.category, a.pictureUrl, " +
        "a.usersLikeCount, a.usersDislikeCount, a.usersCommentCount, a.isUserLiked, " +
        "a.isUserDisliked, a.isUserCommented from articles a join sources s " +
        "on s.sourceId = a.sourceId where s.checked order by a.pubDate desc limit 100")
    ...
    @Query("select a.articleId, a.sourceId, s.sourceName, a.title, a.link, " +
        ...
        "a.usersLikeCount, a.usersDislikeCount, a.usersCommentCount, a.isUserLiked, " +
        "a.isUserDisliked, a.isUserCommented from articles a join sources s " +
        "on s.sourceId = a.sourceId where s.checked and  a.search like :searchText " +
    ...
    @Query("select a.articleId, a.sourceId, s.sourceName, a.title, a.link, " +
        ...
        "a.usersLikeCount, a.usersDislikeCount, a.usersCommentCount, a.isUserLiked, " +
        "a.isUserDisliked, a.isUserCommented from articles a join sources s " +
        "on s.sourceId = a.sourceId where a.articleId = :articleId")
    ...
    @Query("select a.articleId, a.sourceId, s.sourceName, a.title, a.link, " +
        ...
        "a.usersLikeCount, a.usersDislikeCount, a.usersCommentCount, a.isUserLiked, " +
        "a.isUserDisliked, a.isUserCommented from articles a join sources s " +
        "on s.sourceId = a.sourceId where a.isUserLiked or a.isUserCommented or " +
    ...
    @Query("select a.articleId, a.sourceId, s.sourceName, a.title, a.link, " +
        ...
        "a.usersLikeCount, a.usersDislikeCount, a.usersCommentCount, a.isUserLiked, " +
        "a.isUserDisliked, a.isUserCommented from articles a join sources s " +
        "on s.sourceId = a.sourceId where a.search like :searchText and (a.isUserLiked or " +
        "a.isUserCommented or a.isUserDisliked) order by a.pubDate desc  limit 100")
    ...
    @Query("select a.articleId, a.sourceId, s.sourceName, a.title, a.link, " +
        ...
        "a.usersLikeCount, a.usersDislikeCount, a.usersCommentCount, a.isUserLiked, " +
        "a.isUserDisliked, a.isUserCommented from articles a join sources s " +
        "on s.sourceId = a.sourceId where a.sourceId = :sourceId order by a.pubDate desc")
    ...
    @Query("select a.articleId, a.sourceId, s.sourceName, a.title, a.link, " +
        ...
        "a.usersLikeCount, a.usersDislikeCount, a.usersCommentCount, a.isUserLiked, " +
        "a.isUserDisliked, a.isUserCommented from articles a join sources s " +
        "on s.sourceId = a.sourceId where a.search like :searchText and " +
        "a.sourceId = :sourceId order by a.pubDate desc")
